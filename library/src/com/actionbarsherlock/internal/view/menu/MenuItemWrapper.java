...
public class MenuItemWrapper implements MenuItem, android.view.MenuItem.OnMenuItemClickListener {
    ...
    private android.view.MenuItem.OnActionExpandListener mActionExpandListenerMule = null;
    ...
    /**
     * android.view.MenuItem.OnActionExpandListener methods
     */
    
	public MenuItem setOnActionExpandListener(OnActionExpandListener listener) {
		mActionExpandListener = listener;
		// Register ourselves as the listener to proxy
		if (mActionExpandListenerMule == null) {
			mActionExpandListenerMule = new android.view.MenuItem.OnActionExpandListener() {

				@Override
				public boolean onMenuItemActionExpand(android.view.MenuItem item) {
					return MenuItemWrapper.this.onMenuItemActionExpand(item);
				}

				@Override
				public boolean onMenuItemActionCollapse(
						android.view.MenuItem item) {
					return MenuItemWrapper.this.onMenuItemActionCollapse(item);
				}
			};
		}
		mNativeItem.setOnActionExpandListener(mActionExpandListenerMule);
		return this;
	}
