...
public final class ActionBarSherlock {
	 ...
	 */
	private Class<? extends NativeActionBar.Handler> mNativeHandler;
	 ...
	 * @return Current instance for builder pattern.
	 */
	public ActionBarSherlock handleNative(Class<? extends NativeActionBar.Handler> handler) {
		assert this.mAttached == false : ERROR_ATTACHED;
	 ...
	 * -n/a-               *  setDisplayOptions(int options, int mask)
	 * -n/a-               *  setDisplayOptions(int options)
	 ...
	 */
	public static interface SherlockActivity {
		/**
