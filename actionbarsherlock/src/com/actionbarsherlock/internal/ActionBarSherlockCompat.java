...
public class ActionBarSherlockCompat extends ActionBarSherlock implements MenuBuilder.Callback, com.actionbarsherlock.view.Window.Callback, MenuPresenter.Callback, android.view.MenuItem.OnMenuItemClickListener {
    ...
    public ActionBar getActionBar() {
        if (DEBUG) LogManager.getLogger().d(TAG, "[getActionBar]");
    ...
    private void initActionBar() {
        if (DEBUG) LogManager.getLogger().d(TAG, "[initActionBar]");
    ...
    public void setTitle(CharSequence title) {
        if (DEBUG) LogManager.getLogger().d(TAG, "[setTitle] title: " + title);
    ...
    public ActionMode startActionMode(ActionMode.Callback callback) {
        if (DEBUG) LogManager.getLogger().d(TAG, "[startActionMode] callback: " + callback);
    ...
    public void dispatchConfigurationChanged(Configuration newConfig) {
        if (DEBUG) LogManager.getLogger().d(TAG, "[dispatchConfigurationChanged] newConfig: " + newConfig);
    ...
    public void dispatchPostResume() {
        if (DEBUG) LogManager.getLogger().d(TAG, "[dispatchPostResume]");
    ...
    public void dispatchPause() {
        if (DEBUG) LogManager.getLogger().d(TAG, "[dispatchPause]");
    ...
    public void dispatchStop() {
        if (DEBUG) LogManager.getLogger().d(TAG, "[dispatchStop]");
    ...
    public void dispatchInvalidateOptionsMenu() {
        if (DEBUG) LogManager.getLogger().d(TAG, "[dispatchInvalidateOptionsMenu]");
    ...
    public boolean dispatchOpenOptionsMenu() {
        if (DEBUG) LogManager.getLogger().d(TAG, "[dispatchOpenOptionsMenu]");
    ...
    public boolean dispatchCloseOptionsMenu() {
        if (DEBUG) LogManager.getLogger().d(TAG, "[dispatchCloseOptionsMenu]");
    ...
    public void dispatchPostCreate(Bundle savedInstanceState) {
        if (DEBUG) LogManager.getLogger().d(TAG, "[dispatchOnPostCreate]");
    ...
    public boolean dispatchCreateOptionsMenu(android.view.Menu menu) {
        if (DEBUG) {
        	LogManager.getLogger().d(TAG, "[dispatchCreateOptionsMenu] android.view.Menu: " + menu);
        	LogManager.getLogger().d(TAG, "[dispatchCreateOptionsMenu] returning true");
        }
        return true;
    }
    ...
    public boolean dispatchPrepareOptionsMenu(android.view.Menu menu) {
        if (DEBUG) LogManager.getLogger().d(TAG, "[dispatchPrepareOptionsMenu] android.view.Menu: " + menu);
        ...
        if (DEBUG) LogManager.getLogger().d(TAG, "[dispatchPrepareOptionsMenu] returning " + result);
        return result;
    }
    ...
    public boolean dispatchMenuOpened(int featureId, android.view.Menu menu) {
        if (DEBUG) LogManager.getLogger().d(TAG, "[dispatchMenuOpened] featureId: " + featureId + ", menu: " + menu);
    ...
    public void dispatchPanelClosed(int featureId, android.view.Menu menu){
        if (DEBUG) LogManager.getLogger().d(TAG, "[dispatchPanelClosed] featureId: " + featureId + ", menu: " + menu);
    ...
    public void dispatchTitleChanged(CharSequence title, int color) {
        if (DEBUG) LogManager.getLogger().d(TAG, "[dispatchTitleChanged] title: " + title + ", color: " + color);
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        if (DEBUG) LogManager.getLogger().d(TAG, "[dispatchKeyEvent] event: " + event);
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            if (mActionMode != null) {
                ...
                if (DEBUG) LogManager.getLogger().d(TAG, "[dispatchKeyEvent] returning true");
                return true;
            }
        ...
        if (DEBUG) LogManager.getLogger().d(TAG, "[dispatchKeyEvent] returning false");
        return false;
    }
    ...
    public boolean onMenuItemClick(android.view.MenuItem item) {
        if (DEBUG) LogManager.getLogger().d(TAG, "[mNativeItemListener.onMenuItemClick] item: " + item);

        final MenuItemImpl sherlockItem = mNativeItemMap.get(item);
        if (sherlockItem != null) {
            sherlockItem.invoke();
        } else {
        	LogManager.getLogger().e(TAG, "Options item \"" + item + "\" not found in mapping");
        }
    ...
    public void setProgressBarVisibility(boolean visible) {
        if (DEBUG) LogManager.getLogger().d(TAG, "[setProgressBarVisibility] visible: " + visible);
    ...
    public void setProgressBarIndeterminateVisibility(boolean visible) {
        if (DEBUG) LogManager.getLogger().d(TAG, "[setProgressBarIndeterminateVisibility] visible: " + visible);
    ...
    public void setProgressBarIndeterminate(boolean indeterminate) {
        if (DEBUG) LogManager.getLogger().d(TAG, "[setProgressBarIndeterminate] indeterminate: " + indeterminate);
    ...
    public void setProgress(int progress) {
        if (DEBUG) LogManager.getLogger().d(TAG, "[setProgress] progress: " + progress);
    ...
    public void setSecondaryProgress(int secondaryProgress) {
        if (DEBUG) LogManager.getLogger().d(TAG, "[setSecondaryProgress] secondaryProgress: " + secondaryProgress);
    ...
    private int getFeatures() {
        if (DEBUG) LogManager.getLogger().d(TAG, "[getFeatures] returning " + mFeatures);
    ...
    public boolean hasFeature(int featureId) {
        if (DEBUG) LogManager.getLogger().d(TAG, "[hasFeature] featureId: " + featureId);

        boolean result = (mFeatures & (1 << featureId)) != 0;
        if (DEBUG) LogManager.getLogger().d(TAG, "[hasFeature] returning " + result);
        return result;
    }

    @Override
    public boolean requestFeature(int featureId) {
        if (DEBUG) LogManager.getLogger().d(TAG, "[requestFeature] featureId: " + featureId);
    ...
    public void setUiOptions(int uiOptions) {
        if (DEBUG) LogManager.getLogger().d(TAG, "[setUiOptions] uiOptions: " + uiOptions);
    ...
    public void setUiOptions(int uiOptions, int mask) {
        if (DEBUG) LogManager.getLogger().d(TAG, "[setUiOptions] uiOptions: " + uiOptions + ", mask: " + mask);
    ...
    public void setContentView(int layoutResId) {
        if (DEBUG) LogManager.getLogger().d(TAG, "[setContentView] layoutResId: " + layoutResId);
    ...
    public void setContentView(View view, ViewGroup.LayoutParams params) {
        if (DEBUG) LogManager.getLogger().d(TAG, "[setContentView] view: " + view + ", params: " + params);
    ...
    public void addContentView(View view, ViewGroup.LayoutParams params) {
        if (DEBUG) LogManager.getLogger().d(TAG, "[addContentView] view: " + view + ", params: " + params);
    ...
    private void installDecor() {
        if (DEBUG) LogManager.getLogger().d(TAG, "[installDecor]");
            ...
            if (wActionBar != null) {
                ...
                if (splitView != null) {
                    ...
                    mActionModeView.setSplitWhenNarrow(splitWhenNarrow);
                    	...
                    	LogManager.getLogger().e(TAG, "Requested split action bar with incompatible window decor! Ignoring request.");
                }
    ...
    private ViewGroup generateLayout() {
        if (DEBUG) LogManager.getLogger().d(TAG, "[generateLayout]");
        ...
        if (DEBUG) LogManager.getLogger().d(TAG, "[generateLayout] using screen XML " + mActivity.getResources().getString(layoutResource));
    ...
    private static int loadUiOptionsFromManifest(Activity activity) {
        ...
        if (DEBUG) LogManager.getLogger().i(TAG, "Returning " + Integer.toHexString(uiOptions));
        return uiOptions;
    }
    ...
    public void ensureActionBar() {
        if (DEBUG) LogManager.getLogger().d(TAG, "[ensureActionBar]");
