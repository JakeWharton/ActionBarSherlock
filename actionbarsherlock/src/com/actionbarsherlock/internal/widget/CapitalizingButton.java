...
/**
 * {@code CapitalizingButton} is a child of {@link Button}. It's purpose is to
 * capitalise all letters of {@code Button} text and set them as its text. The
 * {@code Button} can have custom style or have default style depending on value
 * of {@code AttributeSet} passed in constructor.
 * 
 */
