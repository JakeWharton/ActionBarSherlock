...
import static com.actionbarsherlock.internal.view.menu.MenuBuilder.ItemInvoker;
...
public final class ExpandedMenuView extends ListView implements ItemInvoker, MenuView, OnItemClickListener {
    ...
    public ExpandedMenuView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SherlockMenuView, 0, 0);
        mAnimations = a.getResourceId(R.styleable.SherlockMenuView_windowAnimationStyle, 0);
        a.recycle();
