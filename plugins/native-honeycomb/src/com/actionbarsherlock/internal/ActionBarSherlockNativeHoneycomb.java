...
import com.actionbarsherlock.internal.app.ActionBarWrapperHoneycomb;
...
@ActionBarSherlock.Implementation(api = 11)
public class ActionBarSherlockNativeHoneycomb extends ActionBarSherlock {
    private ActionBarWrapperHoneycomb mActionBar;
    private ActionModeWrapper mActionMode;
    private MenuWrapper mMenu;

    public ActionBarSherlockNativeHoneycomb(Activity activity, int flags) {
    ...
    private void initActionBar() {
        ...
        mActionBar = new ActionBarWrapperHoneycomb(mActivity);
    }
    ...
    private class ActionModeWrapper extends ActionMode {
        ...
        public MenuInflater getMenuInflater() {
            return ActionBarSherlockNativeHoneycomb.this.getMenuInflater();
        }
    }
}
