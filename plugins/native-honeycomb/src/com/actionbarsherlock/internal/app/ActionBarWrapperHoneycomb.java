...
public class ActionBarWrapperHoneycomb extends ActionBar implements android.app.ActionBar.OnNavigationListener, android.app.ActionBar.OnMenuVisibilityListener {
    ...
    public ActionBarWrapperHoneycomb(Activity activity) {
        mActivity = activity;
